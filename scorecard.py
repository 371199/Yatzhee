...
class Scorecard:
    ...
    def yahtzee(self, dice:list):
        '''Scores the yahtzee. 
        removes the duplicates from the list using set 
        and tests if the length is longer than one.'''
        round_score = 0
    ...
    def full_house(self, dice:list):
        '''Scores full house. removes the duplicates from the list using set and tests if the length is longer than two.'''
        round_score = 0
    ...
    def four_of_a_kind(self, dice:list):
        '''Scores four of a kind. check if 4 of the 5 dice rolls are the same numbers.'''
        round_score = 0 
        dice_score = sum(dice)
    ...
    def three_of_a_kind(self, dice:list):
        '''Scores three of a kind. check if 3 of the 5 dice rolls are the same numbers.'''
        round_score = 0 
        dice_score = sum(dice)
        dice_sorted = sorted(dice)
