...
def roll (dice:list, images:list):
    ...
    for i in range(5):
        ...
        dice.append(num)
    die_spot_1 = tk.Label(image=image_list[dice[0]]).grid(row=1, column=0, padx=25)
    die_spot_2 = tk.Label(image=image_list[dice[1]]).grid(row=1, column=1, padx=25)
    die_spot_3 = tk.Label(image=image_list[dice[2]]).grid(row=1, column=2, padx=25)
    die_spot_4 = tk.Label(image=image_list[dice[3]]).grid(row=1, column=3, padx=25)
    die_spot_5 = tk.Label(image=image_list[dice[4]]).grid(row=1, column=4, padx=25)
    print(dice)
...
roll_button = tk.Button(window, text = 'Roll!', command = lambda: roll(dice, image_list)).grid(row=3, column=2,padx=25)
